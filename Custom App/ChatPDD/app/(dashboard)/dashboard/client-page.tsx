...
export default function DashboardClientPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 relative">
      ...
      {/* A/B Test: Banner Widget (Variant B) */}
      {isWidgetBanner && <GeoSpyBannerWidget />}

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          {/* A/B Test: Floating Widget (Variant D) */}
          {isWidgetFloating && <GeoSpyFloatingWidget />}
          ...
          <Tabs defaultValue="active" className="space-y-6">
            ...
            <TabsContent value="active" className="space-y-6">
              {/* A/B Test: Inline Widget (Variant C) */}
              {isWidgetInline && (
                <GeoSpyABTestWidget className="mb-4" />
              )}
        ...
        <div className="space-y-6">
          {/* A/B Test: Sidebar Widget (Variant A - Current) */}
          {isWidgetInSidebar && <GeoSpyABTestWidget />}
