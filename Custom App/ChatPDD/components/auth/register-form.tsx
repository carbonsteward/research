...
const profileTypes = [
  { value: 'PROJECT_DEVELOPER', label: 'Project Developer', icon: '🌱' },
  { value: 'INVESTOR', label: 'Investor', icon: '💰' },
  { value: 'VALIDATOR', label: 'Validator', icon: '✅' },
  { value: 'CONSULTANT', label: 'Consultant', icon: '💼' },
  { value: 'POLICY_ANALYST', label: 'Policy Analyst', icon: '📊' },
  { value: 'RESEARCHER', label: 'Researcher', icon: '🔬' },
  { value: 'LANDOWNER', label: 'Landowner', icon: '🏞️' },
